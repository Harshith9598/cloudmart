...
/**
 * Redis-backed cache and template configuration for CloudMart. The default
 * cache TTL is 10 minutes; individual cache names override it as needed.
 */
@Configuration
public class RedisConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put("category", defaultConfig.entryTtl(Duration.ofMinutes(15)));
